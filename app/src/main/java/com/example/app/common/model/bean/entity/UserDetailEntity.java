package com.example.app.common.model.bean.entity;
...
public class UserDetailEntity   implements Parcelable {
    ...
    private boolean has_binding,has_binding_google;

    public boolean isHas_binding_google() {
        return has_binding_google;
    }

    public void setHas_binding_google(boolean has_binding_google) {
        this.has_binding_google = has_binding_google;
    }

    private int follower_num,follow_num, store_num;
    ...
    public boolean isHas_binding() {
        return has_binding;
    }

    public void setHas_binding(boolean has_binding) {
